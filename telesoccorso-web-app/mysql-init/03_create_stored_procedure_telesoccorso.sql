...
/*!50003 CREATE*/  /*!50003 FUNCTION `fn_GetDayOfWeek_IT`() RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 FUNCTION `fn_RetIDCode`(p_centrale VARCHAR(50)) RETURNS varchar(50) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 FUNCTION `fn_RetIDProva`(p_AB_CODI VARCHAR(10)) RETURNS varchar(50) CHARSET latin1
    DETERMINISTIC
BEGIN
  DECLARE v_RetCode CHAR(50);
  DECLARE v_date CHAR(8);
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 FUNCTION `fn_RetIDProva_from_CodaProve`(p_AB_CODI VARCHAR(10)) RETURNS varchar(50) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 CREATE*/  /*!50003 FUNCTION `fn_RetIDProva_from_ProveDay`(p_ab_codi VARCHAR(10)) RETURNS varchar(50) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `new_proc`(IN p_ente VARCHAR(50), IN p_descrizione VARCHAR(50), IN p_referente VARCHAR(50), IN p_tel_1 VARCHAR(20), IN p_tel_2 VARCHAR(20), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_cap VARCHAR(5))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_c_CreaFogliProvaDay`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_c_SpostaProveDay_in_NR`(IN p_user VARCHAR(50))
BEGIN
## field per il fetch dei dati ##
  DECLARE  c_ID,c_AB_CODI, c_FOGLIO, c_GIORNO, c_FASCIA, c_USER VARCHAR(50);
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Analisi`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_CodaEve`(IN p_ID_Allarme VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_CodaProve`(IN p_ID VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Convivente`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Ente`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Gmed`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Login`(IN p_id INTEGER(20))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Mdb`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_ProvaUtente`(IN p_IDProva INTEGER)
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_ProveDay`(IN p_IDProva VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_ProveNR`(IN p_IDProva VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Soccamici`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_d_Soccpubb`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Anagrafica`(IN p_ab_codi VARCHAR(10), IN p_matricola VARCHAR(50), IN p_nominativo VARCHAR(50), IN p_sesso VARCHAR(50), IN p_centrale VARCHAR(50), IN p_telefono VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_indirizzo VARCHAR(255), IN p_comune VARCHAR(255), IN p_provincia VARCHAR(2), IN p_cap VARCHAR(50), IN p_tavola VARCHAR(15), IN p_zona VARCHAR(5), IN p_data_nascita DATE, IN p_luogo_nascita VARCHAR(50), IN p_altezza SMALLINT, IN p_peso SMALLINT, IN p_patologia LONGTEXT, IN p_terapia LONGTEXT, IN p_evidenzia LONGTEXT, IN p_note LONGTEXT, IN p_altro LONGTEXT, IN p_dati_abita LONGTEXT, IN p_sopravvivenza VARCHAR(5), IN p_dati_tecnici LONGTEXT, IN p_ente VARCHAR(5))
BEGIN
INSERT INTO
  anagrafica(
AB_CODI,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Analisi`(p_ab_codi VARCHAR(10), p_nominativo VARCHAR(50), p_numero VARCHAR(50), p_tel_1 VARCHAR(50), p_tel_2 VARCHAR(50), p_tel_fax VARCHAR(50), p_referente VARCHAR(50), p_cellulare VARCHAR(50), p_orario VARCHAR(50), p_note VARCHAR(50), p_indirizzo VARCHAR(50), p_comune VARCHAR(50), p_prov VARCHAR(50), p_cap VARCHAR(50))
BEGIN
INSERT INTO `analisi`(
AB_CODI,
NOMINATIVO,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Asi`(IN p_convenzione VARCHAR(50), IN p_dossier VARCHAR(50), IN p_nominativo VARCHAR(50), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_telefono VARCHAR(50), IN p_medico VARCHAR(50), IN p_tempo VARCHAR(50), IN p_uscita VARCHAR(50), IN p_note VARCHAR(50), IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Assenza`(IN p_ab_codi VARCHAR(10), IN p_tipo VARCHAR(50), IN p_note LONGTEXT)
BEGIN
INSERT INTO `assenza`(
AB_CODI,
TIPO,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Coda_prove`(IN p_id VARCHAR(50), IN p_ab_codi VARCHAR(10), IN p_user VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Convivente`(IN p_ab_codi VARCHAR(10), IN p_nominativo VARCHAR(255), IN p_cointestatario VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_sesso VARCHAR(1), IN p_data_nascita VARCHAR(50), IN p_luogo_nascita VARCHAR(50), IN p_altezza SMALLINT, IN p_peso SMALLINT, IN p_patologia LONGTEXT, IN p_terapia VARCHAR(255), IN p_evidenzia VARCHAR(20), IN p_note LONGTEXT, IN p_parentela VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Ente`(IN p_ente VARCHAR(50), IN p_descrizione VARCHAR(50), IN p_tel_1 VARCHAR(50), IN p_tel_2 VARCHAR(50), IN p_referente VARCHAR(50), IN p_comune VARCHAR(50), IN p_indirizzo VARCHAR(50), IN p_cap VARCHAR(5))
BEGIN
INSERT INTO `enti` (
ENTE,
DESCRIZIONE,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_GeneraAllarme`(p_ab_codi VARCHAR(10), p_matricola VARCHAR(50), p_mux VARCHAR(50), p_evento VARCHAR(10), p_centrale VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_GestioneProva`(IN p_ID VARCHAR(50), IN p_Tipo_Allarme VARCHAR(10), IN p_User VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Gmed`(p_ab_codi VARCHAR(10), p_nominativo VARCHAR(50), p_tel_1 VARCHAR(50), p_tel_2 VARCHAR(50), p_numero VARCHAR(50), p_referente VARCHAR(50), p_cellulare VARCHAR(50), p_tipo VARCHAR(50), p_note VARCHAR(50), p_orario VARCHAR(50))
BEGIN
INSERT INTO gmed (
AB_CODI,
NOMINATIVO,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_InsertAllarmi_in_Allarmi`(IN p_id VARCHAR(50), IN p_idprova INTEGER(11), IN p_ab_codi VARCHAR(10), IN p_evento VARCHAR(50), IN p_user VARCHAR(50))
BEGIN
INSERT INTO `allarmi`(
ID_ALLARME,
ID_PROVA,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_InsertAllarmi_in_CodaEve`(p_matricola VARCHAR(10), p_evento VARCHAR(50), p_centrale VARCHAR(50), p_mux VARCHAR(10), p_ritardo VARCHAR(2))
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_InsertAllarmi_in_CodaEve_Brondi`(IN p_telefono VARCHAR(20), IN p_filename VARCHAR(100), IN p_centrale VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_InsertAllarmi_in_CodaEve_Italtel`(IN p_matricola VARCHAR(10), IN p_evento VARCHAR(15), IN p_centrale VARCHAR(50), IN p_mux VARCHAR(5), IN p_ritardo VARCHAR(2))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_InsertProve`(IN p_ab_codi VARCHAR(50), IN p_giorno VARCHAR(50), IN p_foglio VARCHAR(50), IN p_fascia VARCHAR(50), IN p_note VARCHAR(50), IN p_richiamare VARCHAR(50))
BEGIN
INSERT INTO prove
(
AB_CODI,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Login`(IN p_user VARCHAR(50), IN p_foglio VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Mdb`(p_ab_codi VARCHAR(10), p_medico VARCHAR(50), p_indirizzo VARCHAR(50), p_comune VARCHAR(50), p_tel_amb VARCHAR(50), p_tel_casa VARCHAR(50), p_tel_cell VARCHAR(50), p_numero VARCHAR(50), p_specialista VARCHAR(50), p_orario VARCHAR(50))
BEGIN
INSERT INTO medici (
AB_CODI,
MEDICO,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Soccamici`(p_ab_codi VARCHAR(10), p_nominativo VARCHAR(255), p_tel_casa VARCHAR(50), p_tel_uff VARCHAR(50), p_tel_cell VARCHAR(50), p_tempo_casa VARCHAR(50), p_tempo_uff VARCHAR(50), p_chiavi VARCHAR(50), p_coinquilino VARCHAR(50), p_parente VARCHAR(50), p_numero VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Soccpubb`(IN p_ab_codi VARCHAR(10), IN p_tipo VARCHAR(50), IN p_tel_1 VARCHAR(50), IN p_tel_2 VARCHAR(50), IN p_numero VARCHAR(50), IN p_cellulare VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_i_Stipulante`(IN p_ab_codi VARCHAR(10), IN p_nominativo VARCHAR(50), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_prov VARCHAR(50), IN p_cap VARCHAR(50), IN p_telefono VARCHAR(50), IN p_cellulare VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_AllarmeChiuso`(IN p_id_allarme VARCHAR(50))
BEGIN
UPDATE `allarmi`
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Anagrafica`(IN p_ab_codi VARCHAR(10), IN p_matricola VARCHAR(50), IN p_nominativo VARCHAR(50), IN p_sesso VARCHAR(50), IN p_centrale VARCHAR(50), IN p_telefono VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_ente VARCHAR(5))
BEGIN
UPDATE anagrafica
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Asi`(IN p_id INTEGER(11), IN p_diagnosi LONGTEXT, IN p_terapia LONGTEXT, IN p_prognosi LONGTEXT)
BEGIN
UPDATE `asi_gmed`
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Codaprove`(p_ab_codi VARCHAR(10), p_user VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Coda_Eve`(p_user VARCHAR(50), p_id VARCHAR(50))
BEGIN
UPDATE `coda_eve`
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Convivente`(IN p_id VARCHAR(50), IN p_ab_codi VARCHAR(10), IN p_nominativo VARCHAR(255), IN p_cointestatario VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_sesso VARCHAR(1), IN p_data_nascita VARCHAR(50), IN p_luogo_nascita VARCHAR(50), IN p_altezza SMALLINT, IN p_peso SMALLINT, IN p_patologia LONGTEXT, IN p_terapia VARCHAR(255), IN p_evidenzia VARCHAR(20), IN p_note LONGTEXT, IN p_parentela VARCHAR(50))
BEGIN
UPDATE convivente
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Disinstallazione`(IN p_ab_codi VARCHAR(10), IN p_motivo VARCHAR(50))
BEGIN
UPDATE anagrafica
SET
  anagrafica.`MATRICOLA` = '######',
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Ente`(IN p_id INTEGER(11), IN p_ente VARCHAR(5), IN p_descrizione VARCHAR(50), IN p_referente VARCHAR(50), IN p_tel_1 VARCHAR(20), IN p_tel_2 VARCHAR(20), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_cap VARCHAR(5))
BEGIN
UPDATE enti
SET
enti.`ENTE` = p_ente,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Enti`(IN p_id INTEGER(11), IN p_ente VARCHAR(5), IN p_descrizione VARCHAR(50), IN p_referente VARCHAR(50), IN p_tel_1 VARCHAR(20), IN p_tel_2 VARCHAR(20), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_cap VARCHAR(5))
BEGIN
UPDATE enti
SET
enti.`ENTE` = p_ente,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_EsitoAllarme`(IN p_ID VARCHAR(50), IN p_ID_Prova VARCHAR(50), IN p_AB_CODI VARCHAR(10), IN p_Esito VARCHAR(5))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_GestioneAllarme`(IN p_ID_Allarme VARCHAR(50), IN p_Tipo_Allarme VARCHAR(10), IN p_User VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_GestioneCodaProve`(IN p_ID VARCHAR(50), IN p_Tipo_Allarme VARCHAR(10), IN p_User VARCHAR(50))
    COMMENT 'Gestione della prova elencata in Prove Day'
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_GestioneProvaDay`(IN p_ID VARCHAR(50), IN p_Tipo_Allarme VARCHAR(10), IN p_User VARCHAR(50))
    COMMENT 'Gestione della prova elencata in Prove Day'
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Gmed`(IN p_id INTEGER(11), IN p_nominativo VARCHAR(50), IN p_tel_1 VARCHAR(50), IN p_tel_2 VARCHAR(50), IN p_numero VARCHAR(50), IN p_referente VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_tipo VARCHAR(50), IN p_note LONGTEXT, IN p_orario LONGTEXT)
BEGIN
UPDATE gmed
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Infermieri`(IN p_id INTEGER(11), IN p_referto LONGTEXT)
BEGIN
UPDATE `infermieri`
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_InfoAllarme`(IN p_uid VARCHAR(32), IN p_id_allarme VARCHAR(50), IN p_ab_codi VARCHAR(10), IN p_nominativo VARCHAR(255), IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_InfoAllarmeNote`(IN p_id VARCHAR(32), IN p_info LONGTEXT)
BEGIN
     UPDATE `info_allarme`
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Mdb`(IN p_id INTEGER(11), IN p_medico VARCHAR(50), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_tel_amb VARCHAR(50), IN p_tel_casa VARCHAR(50), IN p_tel_cell VARCHAR(50), IN p_numero VARCHAR(50), IN p_specialista VARCHAR(50), IN p_orario LONGTEXT)
BEGIN
UPDATE medici
SET
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_NoteScheda`(IN p_ab_codi VARCHAR(10), IN p_note LONGTEXT)
BEGIN
     UPDATE anagrafica
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Pediatrica`(IN p_id INTEGER(11), IN p_referto LONGTEXT)
BEGIN
UPDATE `pediatrica`
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_ProvaDay_u_Campo_Gestione`(IN p_ID VARCHAR(50), IN p_Tipo_Allarme VARCHAR(10))
    COMMENT 'Gestione della prova elencata in Prove Day'
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Prove`(IN p_id INTEGER(11), IN p_giorno VARCHAR(50), IN p_foglio VARCHAR(50), IN p_fascia VARCHAR(50), IN p_note VARCHAR(50), IN p_richiamare VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Reinstallazione`(IN p_ab_codi VARCHAR(10))
BEGIN
UPDATE anagrafica
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Rientro`(IN p_id INTEGER(11))
BEGIN
UPDATE `assenza`
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_SetUser_in_CodaEve`(IN p_id_allarme VARCHAR(50), IN p_user VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_SetUser_in_ProveDay`(IN p_ID VARCHAR(50), IN p_User VARCHAR(50))
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Soccamici`(IN p_id INTEGER(11), IN p_nominativo VARCHAR(255), IN p_tel_casa VARCHAR(50), IN p_tel_uff VARCHAR(50), IN p_tel_cell VARCHAR(50), IN p_tempo_casa VARCHAR(50), IN p_tempo_uff VARCHAR(50), IN p_chiavi VARCHAR(50), IN p_coinquilino VARCHAR(50), IN p_parente VARCHAR(50), IN p_numero VARCHAR(50))
BEGIN
UPDATE socc_amici
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Soccpubb`(IN p_id INTEGER(11), IN p_tipo VARCHAR(50), IN p_tel_1 VARCHAR(50), IN p_tel_2 VARCHAR(50), IN p_numero VARCHAR(50), IN p_cellulare VARCHAR(50))
BEGIN
UPDATE socc_pub
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_u_Stipulante`(IN p_ab_codi VARCHAR(10), IN p_nominativo VARCHAR(50), IN p_indirizzo VARCHAR(50), IN p_comune VARCHAR(50), IN p_prov VARCHAR(50), IN p_cap VARCHAR(50), IN p_cf VARCHAR(16), IN p_piva VARCHAR(11), IN p_telefono VARCHAR(50), IN p_cellulare VARCHAR(50), IN p_tel_ufficio VARCHAR(50), IN p_referente VARCHAR(50), IN p_imponibile VARCHAR(10), IN p_iva VARCHAR(10), IN p_importo_iva VARCHAR(10), IN p_totale VARCHAR(20), IN p_contratto VARCHAR(50), IN p_pagamento VARCHAR(50), IN p_modo_pagamento VARCHAR(50), IN p_note LONGTEXT, IN p_parentela VARCHAR(50), IN p_email VARCHAR(50))
BEGIN
UPDATE stipulante
SET
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_AllarmiAperti`(IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Anagrafica`(
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Analisi`(p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Asi`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Asi_Scheda`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Assenza`(IN p_ab_codi VARCHAR(10))
BEGIN
      SELECT * FROM `assenza`
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_CodaEveSound`(IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Codaprove`(IN p_user VARCHAR(50))
BEGIN
SELECT * FROM
    `coda_prove`
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Coda_Eve`(IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Context`()
BEGIN
SELECT * FROM `cdr`
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Context_Brondi`()
BEGIN
SELECT * FROM `cdr`
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Convivente`(
IN p_ab_codi VARCHAR(10)
)
BEGIN
      SELECT
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_CountPerEnte`(IN p_User VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_CountProvePerFoglio`(IN p_Day VARCHAR(10), IN p_User VARCHAR(50))
BEGIN
 -- Select prove per foglio con ab_codi in
 -- centrale dell' utente selezionato
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Disinstallato`(IN p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Enti`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Fascia`()
BEGIN
      SELECT
            `prove_fascia`.FASCIA
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_GetPhone`(IN ip_address VARCHAR(15))
BEGIN
SELECT
  `phone_info`.`Channel`
FROM
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Gmed`(p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_His_allarmi`(IN p_ab_codi VARCHAR(10))
BEGIN
      SELECT * FROM `allarmi`
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_His_Assenza`(IN p_ab_codi VARCHAR(50))
BEGIN
SELECT * FROM `assenza`
WHERE `assenza`.`AB_CODI`=p_ab_codi
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_His_eve`(IN p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Infermieri`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Infermieri_Scheda`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_InfoAllarme`(IN p_id_allarme VARCHAR(50))
    COMMENT 'Stored Procedure di gestione allarme gestisce gli Esiti P,C,E,R,'
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Login`(IN p_user VARCHAR(50))
BEGIN
      SELECT
            `login_info`.`USER`,
            `login_info`.`ID_LOGIN`,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Mdb`(p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Moduloallarmi`(IN p_id_allarme VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Pediatrica`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Pediatrica_Scheda_new`(IN p_id INTEGER(11))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_PhoneInfo`(IN p_User VARCHAR(50), IN p_IP_Address VARCHAR(15))
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Prove`(p_ab_codi VARCHAR(10))
BEGIN
      SELECT
            prove.ID,
            prove.AB_CODI,
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Prove_day`(IN p_user VARCHAR(50))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Prove_nr`(IN p_user VARCHAR(50))
BEGIN
SELECT  prove_nr.*
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Richiamare`(IN p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Schedulatore`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Soccamici`(p_ab_codi VARCHAR(10))
BEGIN
      SELECT
             socc_amici.ID,
             socc_amici.AB_CODI,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Soccpubb`(
IN p_ab_codi VARCHAR(10)
)
BEGIN
      SELECT
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_Stipulante`(p_ab_codi VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/  /*!50003 PROCEDURE `sp_v_TecniciAperti`(IN p_user VARCHAR(50))
BEGIN
     SELECT allarmi.`AB_CODI`,
            allarmi.`ID_ALLARME`,
            allarmi.`DATA`,
...
-- Dump completed on 2020-10-18 13:25:48
