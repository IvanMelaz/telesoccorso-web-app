<?php /* Smarty version 2.6.5-dev, created on 2006-05-04 10:40:15
         compiled from db:multimenu_dyn_context.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'db:multimenu_dyn_context.html', 8, false),array('function', 'counter', 'db:multimenu_dyn_context.html', 19, false),)), $this); ?>
<!-- Start multiMenu <?php echo $this->_tpl_vars['block']['mm']; ?>
 -->
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/multiMenu/script/05/context_menu.css">

<div id="context_menu" class="skin" style="width:<?php echo $this->_tpl_vars['block']['block_size']; ?>
px;" display:none>
...
<?php if ($this->_tpl_vars['td'] == 0 || $this->_tpl_vars['top'] == 1): ?>
	<?php if ($this->_tpl_vars['imenu']['link']): ?><a class="menuTop" href="<?php echo $this->_tpl_vars['imenu']['linkurl']; ?>
...
/modules/multiMenu/script/05/context_menu.js"></script>