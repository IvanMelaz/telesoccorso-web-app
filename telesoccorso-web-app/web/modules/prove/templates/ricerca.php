<?php
	   ...
	   $SQL_STRING = "SELECT ".$SELECTED_FIELDS." FROM prove WHERE " ;
	   ...
	   $SQL_STRING = $SQL_STRING." ORDER BY ".$ORDER." ".$SORT ;
		...
		////// HEADER 
		///////////////////////////////////////////////////////
		include "/var/www/modules/prove/templates/header_risultato_ricerca.html";
		...
		*/
		...
		////// FOOTER 
		///////////////////////////////////////////////////////
		include "/var/www/modules/prove/templates/footer_risultato_ricerca.html";
